...
async function pairCommand(sock, chatId, message, q) {
    try {
            ...
            return await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '12036316151685998@newsletter',
            ...
            return await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                       ...
                       newsletterName: 'B͎E͎N͎Z͎I͎ X͎M͎D͎',
                        serverMessageId: -1
                    }
                }
            });
        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(`https://benz-company01.onrender.com/code?number=${number}`);
